...
//
// After running `npx hardhat run scripts/deploy.js --network hardhat`,
// paste the printed addresses here. The ABIs below are generated from the
// compiled contracts. Re-run `npx hardhat compile` if you change the contracts.
// ─────────────────────────────────────────────────────────────────────────────
...
export const NETWORK_CHAIN_ID = 31337; // 31337 = Hardhat local | 11155111 = Sepolia

export const CONTRACT_ADDRESSES = {
  mockUsdc:        "0x5FbDB2315678afecb367f032d93F642f64180aa3", // MockUSDC
  propertyFactory: "0xe7f1725E7734CE288F8367e1Bb143E90bb3F0512", // PropertyFactory
};
